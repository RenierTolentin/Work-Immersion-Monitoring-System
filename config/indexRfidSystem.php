          ...
          <div class="wrapper">
            <div class="modalDialog">
              ...
              <div class="modalFooter">
                <a href="http://localhost/WIMS/" type="button">No</a>
                <a href="config/dtr_exe.php?rfidNumber=<?php echo $rfidNumber.'&time='.$time.'&dtoday='.$dtoday.'&fullname='.$fullname.'&department='.$department.'&time_in'; ?>" class="second">Yes</a>
              </div>        
            </div>
          </div>
        <?php
          ...
          <div class="wrapper">
            <div class="modalDialog">
              ...
              <div class="modalFooter second">
                <a href="http://localhost/WIMS/" type="button">No</a>
                <a href="config/dtr_exe.php?rfidNumber=<?php echo $rfidNumber.'&time='.$time.'&dtoday='.$dtoday.'&fullname='.$fullname.'&department='.$department.'&time_out'; ?>" class="second">Yes</a>
              </div>
            </div>   
          </div>
          <?php
        ...
        if (mysqli_num_rows($checkotin)!=0) { ?>
          <div class="wrapper">
            <div class="modalDialog">
              ...
              <div class="modalFooter">
                <a href="http://localhost/WIMS/" type="button">No</a>
                <a href="config/dtr_exe.php?rfidNumber=<?php echo $rfidNumber.'&time='.$time.'&dtoday='.$dtoday.'&fullname='.$fullname.'&department='.$department.'&ot_in'; ?>" class="second">Yes</a>
              </div>
            </div> 
          </div>
          <?php
        ...
        if (mysqli_num_rows($checkotout)!=0) { ?>
          <div class="modal show" id="myModal3" role="dialog">
            <div class="modalDialog">
              ...
              <div class="modalFooter"> 
                <a href="http://localhost/WIMS/" type="button">No</a>
                <a href="config/dtr_exe.php?rfidNumber=<?php echo $rfidNumber.'&time='.$time.'&dtoday='.$dtoday.'&fullname='.$fullname.'&department='.$department.'&ot_out'; ?>" class="second" >Yes</a>
              </div>
            </div>  
          </div>
          <?php
        ...
        if (mysqli_num_rows($checkall)!=0) { ?>
          <div class="modal show" id="myModal3" role="dialog">
            <div class="modalDialog">
              ...
              <div class="modalFooter">
                <a href="http://localhost/WIMS/" type="button" class="second">Ok</a>
              </div>
            </div>               
          </div>
          <?php	}
